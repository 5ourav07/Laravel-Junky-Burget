        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="row forth_sec">
                <div class="col-sm-4">
                    <div class="menu">
                        <div class="inner_content">
                            <span class="flaticon flaticon-burger"></span>
                            <h3>
                                <a style="color: #fff" href="{{ route('products') }}">
                                    Menu
                                </a>
                            </h3>
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="drinks">
                        <div class="inner_content">
                            ...
                            <h3>
                                <a style="color: #fff" href="{{ route('category', ['category' => 'Drink']) }}">
                                    Drinks
                                </a>
                            </h3>
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="sides">
                        <div class="inner_content">
                            <span style="margin-left: 0" class="flaticon flaticon-food"></span>
                            <h3>
                                <a style="color: #fff" href="{{ route('category', ['category' => 'French Fries']) }}">
                                    French<br>Fries
                                </a>
                            </h3>
                        </div>
